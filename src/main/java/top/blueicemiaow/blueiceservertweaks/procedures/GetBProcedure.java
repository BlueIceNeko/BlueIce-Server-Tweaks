...
public class GetBProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && !_player.level().isClientSide()) {
			...
			_player.displayClientMessage(Component.literal(Lists.getTranslation("max").get() + max + "B"), false);
			_player.displayClientMessage(Component.literal(Lists.getTranslation("total").get() + total + "B"), false);
			_player.displayClientMessage(Component.literal(Lists.getTranslation("free").get() + free + "B"), false);
			_player.displayClientMessage(Component.literal(Lists.getTranslation("used").get() + used + "B"), false);
